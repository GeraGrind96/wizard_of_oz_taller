...
class Face(threading.Thread):
    ...
    def run(self):
        ...
        while not self.stopped:
            ...
            if time.time() - start > sec:
                ...
                start = time.time()
                # print("entro")
            # self.moveFace(pestaneoFlag, self.isTalking, self.pupilaFlag)
    ...
    # def moveFace(self, pestaneoFlag, moveMouthFlag, pupilaFlag):
    def moveFace(self, pestaneoFlag, moveMouthFlag, listeningFlag):
        # if not pestaneoFlag and not moveMouthFlag and not pupilaFlag:
...
class SpecificWorker(GenericWorker):
    ...
    ######################
    # From the RoboCompDisplay you can call this methods:
    # self.display_proxy.setImage(...)
    # self.display_proxy.setImageFromFile(...)

    ######################
    # From the RoboCompDisplay you can use this types:
    # RoboCompDisplay.Image
